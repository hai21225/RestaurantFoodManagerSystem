        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TableId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TableNumer = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_restaurant_tables", x => x.TableId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToppingPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodImageUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    FoodPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    IsAvailable = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InventoryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IngredientId = table.Column<int>(type: "int", nullable: false),
                    Quanlity = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_promotion_categories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_promotion_categories_categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "categories",
                        principalColumn: "CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quanlity = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false),
                    QuanlityBefore = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false),
                    QuanlityAfter = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_inventory_transactions_ingredients_IngredientId",
                        column: x => x.IngredientId,
                        principalTable: "ingredients",
                        principalColumn: "IngredientId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_food_sizes", x => x.SizeId);
                    table.ForeignKey(
                        name: "FK_food_sizes_foods_FoodId",
                        column: x => x.FoodId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_food_toppings", x => new { x.FoodId, x.ToppingId });
                    table.ForeignKey(
                        name: "FK_food_toppings_foods_FoodId",
                        column: x => x.FoodId,
                        principalTable: "foods",
                        principalColumn: "FoodId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_food_toppings_toppings_ToppingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_kitchen_orders", x => x.KitchenOrderId);
                    table.ForeignKey(
                        name: "FK_kitchen_orders_orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_order_status_histories_users_ChangedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_purchase_order_items_ingredients_IngredientId",
                        column: x => x.IngredientId,
                        principalTable: "ingredients",
                        principalColumn: "IngredientId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_order_items_food_sizes_SizeId",
                        column: x => x.SizeId,
                        principalTable: "food_sizes",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_promotion_foods", x => x.Id);
                    table.ForeignKey(
                        name: "FK_promotion_foods_food_sizes_SizeId",
                        column: x => x.SizeId,
                        principalTable: "food_sizes",
                        principalColumn: "SizeId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_promotion_foods_promotions_PromotionId",
                        column: x => x.PromotionId,
                        principalTable: "promotions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_recipes_food_sizes_SizeId",
                        column: x => x.SizeId,
                        principalTable: "food_sizes",
                        principalColumn: "SizeId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_kitchen_order_items_kitchen_orders_KitchenOrderId",
                        column: x => x.KitchenOrderId,
                        principalTable: "kitchen_orders",
                        principalColumn: "KitchenOrderId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_kitchen_order_items_order_items_OrderItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_order_item_toppings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_order_item_toppings_order_items_OrderItemId",
                        column: x => x.OrderItemId,
                        principalTable: "order_items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_order_item_toppings_toppings_ToppingId",
                        column: x => x.ToppingId,
                        principalTable: "toppings",
                        principalColumn: "ToppingId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_recipe_ingredients", x => new { x.RecipeId, x.IngredientId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_food_sizes_FoodId_SizeName",
                table: "food_sizes",
                columns: new[] { "FoodId", "SizeName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_food_toppings_ToppingId",
                table: "food_toppings",
                column: "ToppingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_inventory_transactions_IngredientId",
                table: "inventory_transactions",
                column: "IngredientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_kitchen_order_items_KitchenOrderId",
                table: "kitchen_order_items",
                column: "KitchenOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_kitchen_order_items_OrderItemId",
                table: "kitchen_order_items",
                column: "OrderItemId");

            migrationBuilder.CreateIndex(
                name: "IX_kitchen_orders_OrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_order_item_toppings_OrderItemId",
                table: "order_item_toppings",
                column: "OrderItemId");

            migrationBuilder.CreateIndex(
                name: "IX_order_item_toppings_ToppingId",
                table: "order_item_toppings",
                column: "ToppingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_order_items_SizeId",
                table: "order_items",
                column: "SizeId");

            migrationBuilder.CreateIndex(
                name: "IX_order_status_histories_ChangedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_promotion_categories_CategoryId",
                table: "promotion_categories",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_promotion_categories_PromotionId_CategoryId",
                table: "promotion_categories",
                columns: new[] { "PromotionId", "CategoryId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_promotion_foods_PromotionId_SizeId",
                table: "promotion_foods",
                columns: new[] { "PromotionId", "SizeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_promotion_foods_SizeId",
                table: "promotion_foods",
                column: "SizeId");

            migrationBuilder.CreateIndex(
                name: "IX_purchase_order_items_IngredientId",
